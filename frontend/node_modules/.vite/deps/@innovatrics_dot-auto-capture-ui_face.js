// node_modules/@innovatrics/dot-auto-capture-ui/face.mjs
var po = Object.defineProperty;
var mo = (e, t, n) => t in e ? po(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
...
var ze = {};
var ur = [];
var go = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
...
function Ht(e) {
  (!e.__d && (e.__d = true) && ue.push(e) && !ft.__r++ || Sn !== w.debounceRendering) && ((Sn = w.debounceRendering) || cr)(ft);
}
function ft() {
  var e, t, n, r, o, i, a, s;
...
function rn(e, t, n, r, o, i, a, s, c, u) {
  ...
  e: if (typeof U == "function") try {
    if (p = t.props, m = "prototype" in U && U.prototype.render, k = (d = U.contextType) && r[d.__c], E = d ? k ? k.props.value : d.__ : r, n.__c ? $ = (l = t.__c = n.__c).__ = l.__E : (m ? t.__c = l = new U(p, E) : (t.__c = l = new G(p, E), l.constructor = U, l.render = So), k && k.sub(l), l.props = p, l.state || (l.state = {}), l.context = E, l.__n = r, _ = l.__d = true, l.__h = [], l._sb = []), m && l.__s == null && (l.__s = l.state), m && U.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = ee({}, l.__s)), ee(l.__s, U.getDerivedStateFromProps(p, l.__s))), h = l.props, g = l.state, l.__v = t, _) m && U.getDerivedStateFromProps == null && l.componentWillMount != null && l.componentWillMount(), m && l.componentDidMount != null && l.__h.push(l.componentDidMount);
    else {
      if (m && U.getDerivedStateFromProps == null && p !== h && l.componentWillReceiveProps != null && l.componentWillReceiveProps(p, E), !l.__e && (l.shouldComponentUpdate != null && l.shouldComponentUpdate(p, l.__s, E) === false || t.__v === n.__v)) {
        for (t.__v !== n.__v && (l.props = p, l.state = l.__s, l.__d = false), t.__e = n.__e, t.__k = n.__k, t.__k.forEach(function(Se) {
          Se && (Se.__ = t);
    ...
    if (l.context = E, l.props = p, l.__P = e, l.__e = false, C = w.__r, y = 0, m) {
      for (l.state = l.__s, l.__d = false, C && C(t), d = l.render(l.props, l.state, l.context), F = 0; F < l._sb.length; F++) l.__h.push(l._sb[F]);
      l._sb = [];
    } else do
      l.__d = false, C && C(t), d = l.render(l.props, l.state, l.context), l.state = l.__s;
    while (l.__d && ++y < 25);
...
function wo(e, t, n, r, o, i, a, s, c) {
  ...
  if (e == null) {
    ...
    e = document.createElementNS(o, m, p.is && p), i = null, s = false;
  }
...
Ve = ur.slice, w = { __e: function(e, t, n, r) {
  ...
  this.__v && (this.__e = true, e && this.__h.push(e), Ht(this));
...
}, ft.__r = 0, nn = 0, Dt = bn(false), Mt = bn(true), lr = 0;
function cn() {
...
function $o() {
  var e = new CustomEvent("_preact", { detail: {}, bubbles: true, cancelable: true });
  ...
  if (r.t = e, !r.__c && (r.__ = [n ? n(t) : wr(void 0, t), function(s) {
    ...
    var o = function(s, c, u) {
      ...
      return d.forEach(function(_) {
        if (_.__N) {
          var h = _.__[0];
          _.__ = _.__N, _.__N = void 0, h !== _.__[0] && (l = true);
        }
...
function Bt(e, t) {
  ...
  for (var r in t) if (r !== "__source" && e[r] !== t[r]) return true;
  return false;
}
function Wt(e, t) {
  this.props = e, this.context = t;
...
(Wt.prototype = new G()).isPureReactComponent = true, Wt.prototype.shouldComponentUpdate = function(e, t) {
...
function Mo(e) {
  ...
  return t.$$typeof = Do, t.render = t, t.prototype.isReactComponent = t.__f = true, t.displayName = "ForwardRef(" + (e.displayName || e.name) + ")", t;
}
var Mn = function(e, t) {
  return e == null ? null : te(te(e).map(t));
};
var Ho = { map: Mn, forEach: Mn, count: function(e) {
...
w.unmount = function(e) {
  ...
  var o = $r(r.__v), i = false, a = function() {
    i || (i = true, n.__R = null, o ? o(s) : s());
  };
  n.__R = a;
  var s = function() {
    if (!--r.__u) {
...
var kr = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103;
var jo = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;
var Go = /^on(Ani|Tra|Tou|BeforeInp|Compo)/;
var Vo = /[A-Z0-9]/g;
var Zo = typeof document < "u";
var Yo = function(e) {
...
G.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(e) {
  Object.defineProperty(G.prototype, e, { configurable: true, get: function() {
...
var fn;
var ei = { enumerable: false, configurable: true, get: function() {
  return this.class;
} };
var Bn = w.vnode;
w.vnode = function(e) {
  typeof e.type == "string" && function(t) {
    ...
    for (var i in n) {
      ...
      if (!(i === "value" && "defaultValue" in n && a == null || Zo && i === "children" && r === "noscript" || i === "class" || i === "className")) {
        var s = i.toLowerCase();
        i === "defaultValue" && "value" in n && n.value == null ? i = "value" : i === "download" && a === true ? a = "" : s === "translate" && a === "no" ? a = false : s === "ondoubleclick" ? i = "ondblclick" : s !== "onchange" || r !== "input" && r !== "textarea" || Yo(n.type) ? s === "onfocus" ? i = "onfocusin" : s === "onblur" ? i = "onfocusout" : Go.test(i) ? i = s : r.indexOf("-") === -1 && jo.test(i) ? i = i.replace(Vo, "-$&").toLowerCase() : a === null && (a = void 0) : s = i = "oninput", s === "oninput" && o[i = s] && (i = "oninputCapture"), o[i] = a;
      }
    }
...
var hi = function(t, n, r, o) {
  ...
  for (var c = Object.prototype.hasOwnProperty.bind(n), u = 0; u < a.length; u++) {
    ...
    if (!c(d))
      return false;
    var l = t[d], _ = n[d];
    if (i = r ? r.call(o, l, _, d) : void 0, i === false || i === void 0 && l !== _)
      return false;
  }
  return true;
};
...
var b = {};
var ve = typeof process < "u" && b !== void 0 && (b.REACT_APP_SC_ATTR || b.SC_ATTR) || "data-styled";
var Fr = "active";
var Ur = "data-styled-version";
var St = "6.1.11";
var _n = `/*!sc*/
`;
var pn = typeof window < "u" && "HTMLElement" in window;
var Pi = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && b !== void 0 && b.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && b.REACT_APP_SC_DISABLE_SPEEDY !== "" ? b.REACT_APP_SC_DISABLE_SPEEDY !== "false" && b.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && b !== void 0 && b.SC_DISABLE_SPEEDY !== void 0 && b.SC_DISABLE_SPEEDY !== "" ? b.SC_DISABLE_SPEEDY !== "false" && b.SC_DISABLE_SPEEDY : b.NODE_ENV !== "production");
var Zn = /invalid hook call/i;
...
To resolve this only create new StyledComponents outside of any render method and function component.`, o = console.error;
    try {
      ...
      console.error = function(a) {
        ...
        Zn.test(a) ? (i = false, et.delete(r)) : o.apply(void 0, ye([a], s, false));
...
var Gr = typeof Symbol == "function" && Symbol.for;
var Vr = Gr ? Symbol.for("react.memo") : 60115;
var Ui = Gr ? Symbol.for("react.forward_ref") : 60112;
var Bi = { childContextTypes: true, contextType: true, contextTypes: true, defaultProps: true, displayName: true, getDefaultProps: true, getDerivedStateFromError: true, getDerivedStateFromProps: true, mixins: true, propTypes: true, type: true };
var Wi = { name: true, length: true, prototype: true, caller: true, callee: true, arguments: true, arity: true };
var Zr = { $$typeof: true, compare: true, defaultProps: true, displayName: true, propTypes: true, type: true };
var zi = ((Rt = {})[Ui] = { $$typeof: true, render: true, defaultProps: true, displayName: true, propTypes: true }, Rt[Vr] = Zr, Rt);
function Xn(e) {
...
function qt(e, t, n) {
  if (n === void 0 && (n = false), !n && !Ie(e) && !Array.isArray(e)) return t;
...
function X(e) {
  ...
  return b.NODE_ENV === "production" ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(qi.apply(void 0, ye([Yi[e]], t, false)).trim());
}
var Xi = function() {
  function e(t) {
...
var Ji = "style[".concat(ve, "][").concat(Ur, '="').concat(St, '"]');
var ea = new RegExp("^".concat(ve, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'));
...
var Jn = pn;
var sa = { isServer: !pn, useCSSOMInjection: !Pi };
var Xr = function() {
  function e(t, n, r) {
    t === void 0 && (t = Ne), n === void 0 && (n = {});
    var o = this;
    this.options = L(L({}, sa), t), this.gs = n, this.names = new Map(r), this.server = !!t.isServer, !this.server && pn && Jn && (Jn = false, function(i) {
  ...
  return e.registerId = function(t) {
    ...
    return n === void 0 && (n = true), new e(L(L({}, this.options), t), this.gs, n && this.names || void 0);
...
var ua = new Xr();
var Xt = Kr();
var yn = oe.createContext({ shouldForwardProp: void 0, styleSheet: ua, stylis: Xt });
yn.Consumer;
...
function da(e) {
  var t = W(e.stylisPlugins), n = t[0], r = t[1], o = Qt().styleSheet, i = ne(function() {
    var c = o;
    return e.sheet ? c = e.sheet : e.target && (c = c.reconstructWithOptions({ target: e.target }, false)), e.disableCSSOMInjection && (c = c.reconstructWithOptions({ useCSSOMInjection: false })), c;
...
var eo = function(e) {
  ...
  for (var o in e) {
    var i = e[o];
    e.hasOwnProperty(o) && !Jr(i) && (Array.isArray(i) && i.isCss || Ce(i) ? r.push("".concat(er(o), ":"), i, ";") : Ie(i) ? r.push.apply(r, ye(ye(["".concat(o, " {")], eo(i), false), ["}"], false)) : r.push("".concat(er(o), ": ").concat((t = o, (n = i) == null || typeof n == "boolean" || n === "" ? "" : typeof n != "number" || n === 0 || t in Ai || t.startsWith("--") ? String(n).trim() : "".concat(n, "px")), ";")));
  }
  return r;
};
function _e(e, t, n, r) {
...
var je = oe.createContext(void 0);
je.Consumer;
function to() {
  var e = Ye(je);
  if (!e) throw X(18);
...
function ya(e, t, n) {
  ...
  return k.attrs = h, k.componentStyle = p, k.displayName = l, k.shouldForwardProp = g, k.foldedComponentIds = r ? de(o.foldedComponentIds, o.styledComponentId) : "", k.styledComponentId = _, k.target = r ? o.target : e, Object.defineProperty(k, "defaultProps", { get: function() {
    ...
    this._foldedDefaultProps = r ? function(N) {
      ...
      for (var F = 0, Z = C; F < Z.length; F++) qt(N, Z[F], true);
      return N;
    }({}, o.defaultProps, E) : E;
  } }), b.NODE_ENV !== "production" && (Li(l, _), k.warnTooManyClasses = /* @__PURE__ */ function(E, N) {
    var C = {}, y = false;
    return function(F) {
      if (!y && (C[F] = true, Object.keys(C).length >= 200)) {
...
Example:
  ...
  }), i && Yr(k, e, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), k;
}
function nr(e, t) {
...
function vn(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  if (Ce(e) || Ie(e)) return rr(_e(nr(Et, ye([e], t, true))));
  var r = e;
...
function Jt(e, t, n) {
  ...
  var r = function(o) {
    ...
    return e(t, n, vn.apply(void 0, ye([o], i, false)));
  };
...
function bt(e) {
  ...
  var r = Yt(vn.apply(void 0, ye([e], t, false))), o = zr(r);
  return new Kt(o, r);
}
...
var ro = 14;
var Ca = 0.0276;
var J = ((e) => (e[e.S = 300] = "S", e[e.M = 400] = "M", e[e.L = 500] = "L", e[e.Default = 600] = "Default", e))(J || {});
var Fe = {
  300: {
    iconSize: 40,
    marginLeft: 12,
...
var or = {
  loading: { text: "Loading. Please wait.", visible: true },
  waiting: { text: "Waiting for input...", visible: true }
};
var wa = {
...
var Sa = M.CIRCLE_SOLID;
var Ea = "rgba(19, 19, 19, 0.5)";
var ba = 34;
function ir(e, t) {
  return Math.max(t, t + (e - 400) * Ca + 2);
}
var $a = (e, t = ro) => e ? e.width < e.height ? ir(e.width, t) : ir(e.height, t) : t;
var ka = (e) => e > J.Default ? Fe[J.Default] : e > J.L ? Fe[J.L] : e > J.M ? Fe[J.M] : Fe[J.S];
var Oa = (e) => e ? ka(e.width) : Fe[J.Default];
function Na() {
...
function Ia({ children: e, props: t, videoElementSize: n }) {
  ...
  return f(We.Provider, { value: o, children: e });
}
var oo = ({ svgSize: e }) => f("svg", { fill: "none", height: e, viewBox: "0 0 16 14", width: e, xmlns: "http://www.w3.org/2000/svg", children: f(
  "path",
  {
    clipRule: "evenodd",
...
var Ra = H.p`
  ...
  max-width: 80%;
`;
var en = ({ Icon: e, isCameraReady: t, position: n = "absolute", text: r }) => {
  const { fontSize: o } = we();
  return f(Ta, { $isCameraReady: t, $position: n, children: f(xa, { children: [
    e ? f(e, { svgSize: o * 2 }) : null,
    f(Ra, { $fontSize: o, children: r })
  ] }) });
};
var io = ({ text: e = "An unknown error has occurred" }) => f(en, { Icon: oo, position: "relative", text: e });
var Aa = class extends G {
  ...
  render() {
    return this.state.hasError ? f(io, { Icon: oo, isCameraReady: false }) : this.props.children;
  }
};
var Pa = H.div`
...
`;
var La = ({ children: e, uiProps: t, videoElementSize: n }) => (re(() => {
  Na();
}, []), f(da, { target: t.styleTarget, children: f(ga, { theme: t.theme, children: f(Pa, { children: f(Aa, { videoElementSize: n, children: f(Ia, { props: t, videoElementSize: n, children: e }) }) }) }) }));
var Da = 0.75;
var Ma = 2;
var Ha = "dot-auto-capture-video";
var Ge = (e, t) => {
  const n = Ze(t);
  re(() => {
    n.current = t;
...
var ja = (e) => Number.parseFloat(e.toFixed(3));
var ao = (e, t) => Math.min(e, t);
var Ga = ({ height: e, width: t }, n) => {
...
var pt = class pt2 {
  ...
  static getInstance() {
    return this._instance || (this._instance = new pt2()), this._instance;
  }
  restart() {
   ...
   */
  isDetailChanged(t, n) {
    return JSON.stringify(n) !== JSON.stringify(this.lastDetails[t]) ? (this.lastDetails[t] = n, true) : false;
  }
  /**
...
var Ka = () => {
  ...
  return re(() => {
    (async () => {
      (await Qa()).length > 1 && t(true);
    })();
  }, []), e;
};
var Ja = ({ size: e }) => f("svg", { fill: "none", height: e, viewBox: "0 0 52 52", width: e, xmlns: "http://www.w3.org/2000/svg", children: [
  f(
    "path",
    {
  ...
  f("circle", { cx: "17.5", cy: "24.5", fill: "white", r: "1.5" }),
  f(
    "path",
    {
  ...
  f("circle", { fill: "white", r: "1.5", transform: "matrix(-1 0 0 1 34.5 24.5)" }),
  f(
    "path",
    {
...
var es = ({ size: e }) => f("svg", { fill: "none", height: e, viewBox: "0 0 52 52", width: "52", xmlns: "http://www.w3.org/2000/svg", children: [
  f("circle", { cx: "26", cy: "26", fill: "#131313", fillOpacity: "0.3", r: "26" }),
  f(
    "path",
    {
...
`;
var ts = ({ marginLeft: e, size: t, ...n }) => f(co, { $marginLeft: e, ...n, children: f(Ja, { size: t }) });
var ns = ({ marginLeft: e, size: t, ...n }) => f(co, { $marginLeft: e, ...n, children: f(es, { size: t }) });
var rs = H.div`
  position: absolute;
  top: 0;
  right: 0;
...
var os = ({
  ...
  return f(rs, { $padding: i, children: [
    o && f(ns, { disabled: t, onClick: () => {
...
`;
var as = ({ svgSize: e }) => f(is, { children: f("svg", { fill: "none", height: e, viewBox: "0 0 48 48", width: e, xmlns: "http://www.w3.org/2000/svg", children: [
  f(
    "path",
    {
...
var ss = H.div`
  ...
  height: 100%;
`;
var lo = ({ children: e, height: t, width: n }) => {
  const { backdropColor: r } = we();
  return f(ss, { children: f("svg", { viewBox: `0 0 ${n} ${t}`, children: [
    f("defs", { children: f("mask", { id: "mask", children: [
      f("rect", { fill: "#fff", height: "100%", width: "100%" }),
      e
    ] }) }),
    f("rect", { fill: r, height: "100%", mask: "url(#mask)", width: "100%" })
  ] }) });
};
var cs = ({ cameraHeight: e, cameraWidth: t, isBackdrop: n, state: r }) => {
  const { appStateInstructions: o } = we(), i = r === q.ERROR || r === q.RUNNING;
  return !r || i || !(o != null && o[r].visible) ? null : r === q.WAITING ? f(z, { children: [
    n && e && t && f(lo, { height: e, width: t }),
    f(en, { isCameraReady: true, text: o[q.WAITING].text })
  ] }) : f(en, { Icon: as, isCameraReady: true, text: o[q.LOADING].text });
};
var ls = "2.5s";
var us = "0.3s";
var fs = "linear";
...
var ps = ({
  ...
  const { fontSize: a } = we();
  return f(hs, { $cssBottom: t, $cssTop: n, $isAnimating: r, $isPortrait: i, children: f(
    _s,
    {
      $fontSize: a,
      $isInCandidateSelection: o,
...
function ms(e) {
  return f("rect", { fill: "#000", ...e, rx: "50%" });
}
var gs = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "path",
  {
...
var ys = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "path",
  {
...
var vs = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "path",
  {
    clipRule: "evenodd",
...
var Cs = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "rect",
  {
    height: "476",
    rx: "2",
...
var ws = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "rect",
  {
    height: "476",
    rx: "14",
...
var Ss = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f("rect", { height: "476", rx: "14", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "4", width: "476", x: "2", y: "2" }) });
var Es = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f("rect", { height: "476", rx: "2", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "4", width: "476", x: "2", y: "2" }) });
var bs = () => f("svg", { fill: "none", height: "480", viewBox: "0 0 480 480", width: "480", xmlns: "http://www.w3.org/2000/svg", children: f(
  "path",
  {
    clipRule: "evenodd",
...
var Os = {
  [M.CIRCLE_SOLID]: f(gs, {}),
  [M.ELLIPSE_SOLID]: f(ys, {}),
  [M.MAN_SOLID]: f(vs, {}),
  [M.WOMAN_SOLID]: f(bs, {}),
  [M.SQUARE_ROUNDED_DASH]: f(ws, {}),
  [M.SQUARE_ROUNDED_SOLID]: f(Ss, {}),
  [M.SQUARE_DASH]: f(Cs, {}),
  [M.SQUARE_SOLID]: f(Es, {})
};
var Ns = ({ backdropHeight: e, backdropWidth: t, isBackdrop: n, placeholderRectangle: r, ...o }) => {
  const { placeholder: i } = we();
  return f(z, { children: [
    n && f(lo, { height: e, width: t, children: f(
      ms,
      {
        height: `${r.height * 100}%`,
        width: `${r.width * 100}%`,
    ...
    f(ks, { placeholderRectangle: r, ...o, children: Os[i] })
  ] });
};
var Is = () => {
  const [e, t] = W(), [n, r] = W(false), o = ge(
    (c) => {
      var d, l;
  ...
  const [i, a] = W({
    ...
    (c) => {
      ...
      a({
        ...
        isEscalated: ((d = c == null ? void 0 : c.detail) == null ? void 0 : d.isEscalated) ?? false
      });
    },
    [a]
  );
...
var As = ({ cameraResolution: e, isImageMirror: t }) => {
  ...
  return Ge(me.DETECTED_FACE_CHANGED, a), re(() => {
    ...
    const s = (c, u) => {
      ...
      if (!_)
        return;
      const h = qa(l, c);
      _.beginPath(), _.arc(d.x, d.y, h, 0, 2 * Math.PI, false), _.lineWidth = va, _.strokeStyle = r.colors.placeholderColor, _.stroke();
    };
    n.current.width = e.width, n.current.height = e.height, Rs(n.current), s(e, o);
  }, [e, o, r.colors.placeholderColor]), f(xs, { ref: n, $isImageMirror: t });
};
var Ps = () => {
  ...
  if (e === q.ERROR)
    return f(io, { text: t == null ? void 0 : t.message });
  if (e === q.RUNNING && n) {
    const d = Ya(n);
    return f(z, { children: [
      c && f(As, { cameraResolution: n, isImageMirror: o }),
      f(
        Ns,
        {
      ...
      f(os, { customControlEvent: me.CONTROL, isSwitchCameraDisabled: i })
    ] });
  }
  return f(
    cs,
...
var Ls = (e) => {
  ...
  }, r = (e == null ? void 0 : e.placeholder) ?? Sa, o = (e == null ? void 0 : e.backdropColor) ?? Ea, i = (e == null ? void 0 : e.showDetectionLayer) ?? false, a = (e == null ? void 0 : e.showCameraButtons) ?? false, s = za(e == null ? void 0 : e.theme);
...
var Ds = ({ props: e }) => {
  ...
  return f(La, { uiProps: Ls(e), videoElementSize: t, children: f(Ps, {}) });
};
No(Ds, "x-dot-face-auto-capture-ui", ["props"]);
//# sourceMappingURL=@innovatrics_dot-auto-capture-ui_face.js.map
