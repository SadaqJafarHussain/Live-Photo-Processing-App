...
var Ve, b, lr, le, Sn, ur, Lt, nn, Dt, Mt, fr, Ge = {}, dr = [], vo = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, mt = Array.isArray;
function Q(e, t) {
...
function Ht(e) {
  (!e.__d && (e.__d = !0) && le.push(e) && !ft.__r++ || Sn !== b.debounceRendering) && ((Sn = b.debounceRendering) || ur)(ft);
}
function ft() {
  var e, t, n, r, o, i, a, s;
  for (le.sort(Lt); e = le.shift(); ) e.__d && (t = le.length, r = void 0, i = (o = (n = e).__v).__e, a = [], s = [], n.__P && ((r = Q({}, o)).__v = o.__v + 1, b.vnode && b.vnode(r), rn(n.__P, r, o, n.__n, n.__P.namespaceURI, 32 & o.__u ? [i] : null, a, i ?? me(o), !!(32 & o.__u), s), r.__v = o.__v, r.__.__k[r.__i] = r, gr(a, r, s), r.__e != i && hr(r)), le.length > t && le.sort(Lt));
  ft.__r = 0;
}
...
function wo(e, t, n) {
  ...
  for (e.__k = [], r = 0; r < l; r++) a = r + c, (o = e.__k[r] = (o = t[r]) == null || typeof o == "boolean" || typeof o == "function" ? null : typeof o == "string" || typeof o == "number" || typeof o == "bigint" || o.constructor == String ? Fe(null, o, null, null, null) : mt(o) ? Fe(j, { children: o }, null, null, null) : o.constructor === void 0 && o.__b > 0 ? Fe(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : o) != null ? (o.__ = e, o.__b = e.__b + 1, s = So(o, n, a, d), o.__i = s, i = null, s !== -1 && (d--, (i = n[s]) && (i.__u |= 131072)), i == null || i.__v === null ? (s == -1 && c--, typeof o.type != "function" && (o.__u |= 65536)) : s !== a && (s == a - 1 ? c = s - a : s == a + 1 ? c++ : s > a ? d > l - a ? c += s - a : c-- : s < a && c++, s !== r + c && (o.__u |= 65536))) : (i = n[a]) && i.key == null && i.__e && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = me(i)), Ut(i, i, !1), n[a] = null, d--);
...
function rn(e, t, n, r, o, i, a, s, l, u) {
  var d, c, h, f, p, y, v, m, g, N, E, x, S, C, M, V, H = t.type;
  if (t.constructor !== void 0) return null;
  128 & n.__u && (l = !!(32 & n.__u), i = [s = t.__e = n.__e]), (d = b.__b) && d(t);
  e: if (typeof H == "function") try {
    ...
    if (c.context = E, c.props = m, c.__P = e, c.__e = !1, S = b.__r, C = 0, g) {
    ...
    t.__v = null, l || i != null ? (t.__e = s, t.__u |= l ? 160 : 32, i[i.indexOf(s)] = null) : (t.__e = n.__e, t.__k = n.__k), b.__e(we, t, n);
  }
  else i == null && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = bo(n.__e, t, n, r, o, i, a, l, u);
  (d = b.diffed) && d(t);
}
function gr(e, t, n) {
  t.__d = void 0;
...
function Ut(e, t, n) {
  var r, o;
  if (b.unmount && b.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || on(r, null, t)), (r = e.__c) != null) {
...
function ae(e, t, n) {
  var r, o, i, a;
  b.__ && b.__(e, t), o = (r = typeof n == "function") ? null : n && n.__k || t.__k, i = [], a = [], rn(t, e = (!r && n || t).__k = L(j, null, [e]), o || Ge, Ge, t.namespaceURI, !r && n ? [n] : o ? null : t.firstChild ? Ve.call(t.childNodes) : null, i, !r && n ? n : o ? o.__e : t.firstChild, r, a), gr(i, e, a);
}
function an(e, t) {
  ae(e, t, an);
}
...
Ve = dr.slice, b = { __e: function(e, t, n, r) {
...
var se, O, Tt, kn, $e = 0, wr = [], I = b, xn = I.__b, Tn = I.__r, On = I.diffed, In = I.__c, An = I.unmount, Rn = I.__;
function Oe(e, t) {
...
}, useCallback: _e, useContext: Ye, useDebugValue: dt, useDeferredValue: Ir, useEffect: ne, useId: br, useImperativeHandle: Sr, useInsertionEffect: Rr, useLayoutEffect: Ie, useMemo: te, useReducer: ln, useRef: Ze, useState: B, useSyncExternalStore: Pr, useTransition: Ar } } };
function oi(e) {
...
function Ti(e) {
  return Ei(ct("", null, null, null, [""], e = bi(e), 0, [0], e));
}
      ...
      case 0:
        switch (g) {
          ...
          case 59:
            C += ";";
          default:
            if (He(S = Gn(C, t, n, u, d, o, s, N, E = [], x = [], c, i), i), g === 123)
              if (d === 0)
                ct(C, t, S, S, E, i, c, s, x);
              else
                switch (h === 99 && R(C, 3) === 110 ? 100 : h) {
                  ...
                  case 109:
                  case 115:
                    ct(e, S, S, r && He(Gn(e, S, S, 0, 0, o, s, N, o, E = [], c, x), x), o, x, c, s, r ? E : x);
                    break;
                  default:
                    ct(C, S, S, S, [""], x, 0, s, x);
                }
        ...
        if (e.length)
          return Ci(n = e.props, function(o) {
            switch (K(o, r = /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                be(ie(e, { props: [w(o, /:(read-\w+)/, ":" + ze + "$1")] })), be(ie(e, { props: [o] })), Wt(e, { props: Wn(n, r) });
                break;
              case "::placeholder":
                be(ie(e, { props: [w(o, /:(plac\w+)/, ":" + k + "input-$1")] })), be(ie(e, { props: [w(o, /:(plac\w+)/, ":" + ze + "$1")] })), be(ie(e, { props: [w(o, /:(plac\w+)/, T + "input-$1")] })), be(ie(e, { props: [o] })), Wt(e, { props: Wn(n, r) });
                break;
            }
            return "";
          });
...
var Li = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, $ = {}, ye = typeof process < "u" && $ !== void 0 && ($.REACT_APP_SC_ATTR || $.SC_ATTR) || "data-styled", zr = "active", Wr = "data-styled-version", St = "6.1.11", hn = `/*!sc*/
...
}, bt = Object.freeze([]), xe = Object.freeze({});
function Hi(e, t, n) {
...
}, ta = "style[".concat(ye, "][").concat(Wr, '="').concat(St, '"]'), na = new RegExp("^".concat(ye, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), ra = function(e, t, n) {
...
var Jr = function(e) {
  ...
  r.setAttribute(ye, zr), r.setAttribute(Wr, St);
  var a = ia();
...
function to(e) {
  var t, n, r, o = e === void 0 ? xe : e, i = o.options, a = i === void 0 ? xe : i, s = o.plugins, l = s === void 0 ? bt : s, u = function(h, f, p) {
...
function pe(e, t, n, r) {
  ...
  var i;
  return e instanceof Jt ? n ? (e.inject(n, r), [e.getName(r)]) : [e] : Te(e) ? ro(e) : Array.isArray(e) ? Array.prototype.concat.apply(bt, e.map(function(a) {
    return pe(a, t, n, r);
  })) : [e.toString()];
}
function ma(e) {
...
function Ca(e, t, n) {
  var r = mn(e), o = e, i = !Rt(e), a = t.attrs, s = a === void 0 ? bt : a, l = t.componentId, u = l === void 0 ? function(E, x) {
    var S = typeof E != "string" ? "sc" : Zn(E);
    Pt[S] = (Pt[S] || 0) + 1;
    var C = "".concat(S, "-").concat(Vr(St + S + Pt[S]));
  ...
  function g(E, x) {
    return function(S, C, M) {
      var V = S.attrs, H = S.componentStyle, we = S.defaultProps, _o = S.foldedComponentIds, Cn = S.styledComponentId, ho = S.target, po = re.useContext(je), mo = Kt(), $t = S.shouldForwardProp || mo.shouldForwardProp;
      $.NODE_ENV !== "production" && dt(Cn);
      var wn = Hi(C, po, we) || xe, X = function(qe, Le, Xe) {
        for (var Se, ce = P(P({}, Le), { className: void 0, theme: Xe }), xt = 0; xt < qe.length; xt += 1) {
          var Ke = ve(Se = qe[xt]) ? Se(ce) : Se;
      ...
      var Nt = function(qe, Le) {
        var Xe = Kt(), Se = qe.generateAndInjectStyles(Le, Xe.styleSheet, Xe.stylis);
        return $.NODE_ENV !== "production" && dt(Se), Se;
      }(H, X);
      $.NODE_ENV !== "production" && S.warnTooManyClasses && S.warnTooManyClasses(Nt);
      var kt = fe(_o, Cn);
  ...
  return N.attrs = f, N.componentStyle = m, N.displayName = c, N.shouldForwardProp = p, N.foldedComponentIds = r ? fe(o.foldedComponentIds, o.styledComponentId) : "", N.styledComponentId = h, N.target = r ? o.target : e, Object.defineProperty(N, "defaultProps", { get: function() {
    ...
    this._foldedDefaultProps = r ? function(x) {
      ...
      for (var M = 0, V = S; M < V.length; M++) qt(x, V[M], !0);
      return x;
    }({}, o.defaultProps, E) : E;
...
function vn(e) {
  for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
  if (ve(e) || Te(e)) return nr(pe(tr(bt, ge([e], t, !0))));
  var r = e;
...
}, rr = 0.24, wa = 24, Sa = 2, so = 14, ba = 0.0276;
...
const Ue = {
  ...
  [z.PALM_TOO_CLOSE]: "Center your palm"
}, ka = ao.WITHOUT_FINGERS;
function ir(e, t) {
  return Math.max(t, t + (e - 400) * ba + 2);
}
...
function Cs({ cameraResolution: e, isImageMirror: t }) {
  ...
  return Ee(Cr.DETECTED_DOCUMENT_CHANGED, a), Ee(de.DETECTED_PALM_CHANGED, a), ne(() => {
    ...
    const s = (u, d, c, h) => {
      ...
      m && (m.beginPath(), m.lineWidth = Sa, m.strokeStyle = r.colors.placeholderColor, m.moveTo(y.x, y.y), m.arcTo(d.x, d.y, v.x, v.y, wa), m.lineTo(v.x, v.y), m.stroke());
    }, l = (u) => {
      if (!u)
        return;
...
function $s({ placeholderRectangle: e, ...t }) {
  ...
  return /* @__PURE__ */ _(bs, { placeholderRectangle: e, ...t, children: Es[n] });
}
function Ns() {
